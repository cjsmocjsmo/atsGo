...
# s9 = re.compile(r"Venom Let There Be Carnage")
# s10 = re.compile(r"Venom.Let.There.Be.Carnage")
# s11 = re.compile(r"Star.Trek.Prodigy")
...
# s47 = re.compile(r"Book Of Boba Fett")
# s48 = re.compile(r"The Book Of Boba Fett")
# s49 = re.compile(r"Star Wars Book Of Boba Fett")

# s50 = re.compile(r"Star Wars The Book Of Boba Fett")
# s51 = re.compile(r"Book.Of.Boba.Fett")
# s52 = re.compile(r"The.Book.Of.Boba.Fett")
# s53 = re.compile(r"Star.Wars.Book.Of.Boba.Fett")
# s54 = re.compile(r"Star.Wars.The.Book.Of.Boba.Fett")
...
# s87 = re.compile(r'Matrix Resurrections')
# s88 = re.compile(r'Matrix.Resurrections')

# s89 = re.compile(r"Venom")
...
class FeedChecker:
    ...
    def __init__(self):
        try:
            os.stat('/home/logs/TGtv.log')
        except FileNotFoundError:
            with open('/home/logs/TGtv.log', 'w') as newfile:
                newfile.write("Log created")

        logging.basicConfig(
            filename ='/home/logs/TGtv.log',
            level = logging.DEBUG,
